...
const navItems = [
  ...
  {
    name: "Community",
    href: "/dashboard/community-recipes",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-neutral-200">
        ...
        <div className="p-4 border-t border-neutral-200">
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-neutral-100 cursor-pointer transition-all">
          ...
          <button
            ...
            className="w-full mt-2 flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-all"
          >
      ...
      <main className="flex-1 lg:ml-64">
        ...
        <header className="lg:hidden sticky top-0 z-40 bg-white border-b border-neutral-200">
          <div className="flex items-center justify-between h-16 px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg text-neutral-900">NepFit</span>
            </div>
            <button
              onClick={handleLogout}
        ...
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 safe-area-inset-bottom">
